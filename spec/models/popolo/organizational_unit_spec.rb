...
describe Popolo::OrganizationalUnit do
  ...
  describe '#create' do
    ...
    it 'should prevent duplicate slugs' do
      Popolo::OrganizationalUnit.create name: 'Foo', slug: 'foo'
      expect {Popolo::OrganizationalUnit.with(safe: true).create(name: 'Bar', slug: 'foo')}.to raise_error(Moped::Errors::OperationFailure)
    end
  end
